...
int main(int argc,char *argv[])
{
  if (argc!=5)
  {
    ...
    printf("/oracle/htidc/shqx/bin/psurfdata1 数据文件存放的目录 日志文件名 数据库连接参数 程序运行时间间隔\n");
    printf("例如：/oracle/htidc/shqx/bin/psurfdata1 /oracle/data/shqx/sdata/surfdata /oracle/log/shqx/psurfdata1.log scott/tiger@snorcl11g_128 10\n");
    return -1;
  }
