...
int main(int argc,char *argv[])
{
  ...
  {
    printf("\n本程序用于处理全国逐小时雨量实况图片文件。\n\n");
    printf("/ProDir/shqx/bin/pzhrain24file logfilename connstr srcpathname dstpathname tname timetvl\n");
    printf("例如：/shqx/shqx/bin/pzhrain24file /log/shqx/pzhrain24file.log shqx/pwdidc@snorcl11g_31 /data/wfile/zhrain24 /qxfile/zhrain24 T_ZHRAIN24 30\n");
...
bool _pzhrain24file(char *strargv2,char *strargv4,char *strargv5)
{
  ...
  if (conn.m_state==0)
  {
    if (conn.connecttodb(strargv2,"SIMPLIFIED CHINESE_CHINA.AL32UTF8")!=0)
    {
