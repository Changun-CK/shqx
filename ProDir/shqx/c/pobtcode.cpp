...
connection conn;
/* 处理数据文件 */
bool _pobtcode(const char *inifilename);
...
int main(int argc, char *argv[])
{
	if (argc != 3)
	{
		...
		printf("\n用法: /ProDir/shqx/bin/pobtcode 数据文件name 数据库连接参数.\n");
		printf("\n例如: /ProDir/shqx/bin/pobtcode /ProDir/shqx/ini/stcode.ini shqx/pwdidc@snorcl11g_31\n\n");
		return -1;
	}
