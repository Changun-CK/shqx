...
int main(int argc, char *argv[])
{
	if (argc!=4)
	{
		...
		printf("\n用法: /ProDir/shqx/bin/crtsurfdata 站点参数 数据文件存放的目录 日志文件名\n");
		printf("\n例如: /ProDir/shqx/bin/crtsurfdata /ProDir/shqx/ini/stcode.ini /data/shqx/ftp/surfdata /log/shqx/crtsurfdata.log\n\n");
		return -1;
	}
...
bool CrtSurfFile(const char *outpath)
{
	...
	snprintf(strFileName, sizeof(strFileName), "%s/SURF_ZH_%s_%d.txt", outpath, strLocalTime, getpid());
