...
int main(int argc, char *argv[])
{
  ...
  while (true)
  {
    ...
    snprintf(strwgetclient,2000,"/ProDir/public/bin/wgetclient \"http://products.weather.com.cn/product/Index/index/procode/JC_JSL_ZH.shtml\" %s/wgetclient_%d.tmp  %s/wgetclient_%d.html %s/wgetclient.log utf-8",argv[2],getpid(),argv[2],getpid(),argv[2]);
    //if (system(strwgetclient) != 0) { logfile.Write("wgetclient is failed.\n"); sleep(3); continue; }
